...
class Server(object):
    ...
    def __init__(self):
        ...
        self.directory_name = "json_files_2"
        self.LIMITE_CPU_percentuale = None  # la percentuale di utilizzo prima delle richieste è 0.054
    ...
    def salvo_file_ricevuto(self, titolo, contenuto):
        ...
        json_filename = f"{self.directory_name}/{timestamp}_{titolo}"
    ...
    def monitoraggio_carico_server(self):
        ...
        print("Percentuale di memoria inziale utilizzata:", starting_memory_percent)
