...
class server(object):
    ...
    def monitor_keyboard_input(self):
        """
        Metodo che esegue un monitoraggio continuo dell'input da tastiera. In particolare, viene creato un listener
           che richiama la funzione handle_esc_key quando viene premuto un tasto sulla tastiera. Entra in un ciclo while che continua
           ad eseguire fin quando il flag di spegnimento non è attivo.
    ...
    def handle_esc_key(self, key):
        """
   #     Metodo che imposta il flag di spegnimento se viene premuto il tasto esc.
   #     :param key:
   ...
   #     """
    ...
    def shutdown(self):
        """
   #     Metodo che esegue una procedura di spegnimento del programma, chiudendo le socket aperte.
   #     :return:
   #     """
        print("Shutting down...")
    ...
    def gestione_client(self):
        ...
        while not self.shutdown_event.is_set():
            try:
                ...
                thread_richieste_client = threading.Thread(target=self.richieste_client,
